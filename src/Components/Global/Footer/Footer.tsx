      ...
      <Content>
        <AboutCompanyLinkSections>
          <AboutCompany>
            ...
            <CompanyDesc>
              Antern is where lifelong learners come to learn the skills they
              need, to land the jobs they want, to build the lives they deserve.
            </CompanyDesc>
          </AboutCompany>
          <LinkSections>
            {linkSections.map(({ heading, links }, index) => (
              <LinkSection key={index}>
                <LinkSectionHeading>{heading}</LinkSectionHeading>
                <LinkSectionLinks>
